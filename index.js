...
// For Railway deployment: Use webhook for production and polling for development
if (process.env.NODE_ENV === 'production') {
  // Get PORT from environment (needed for Railway)
  ...
  app.get('/', (req, res) => {
    res.send('Vehicle Bot server is running!');
  });
  ...
  bot.launch()
    .then(() => {
      console.log('Vehicle Info Bot is running in development mode!');
    })
    .catch(err => {
